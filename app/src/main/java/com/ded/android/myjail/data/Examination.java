package com.ded.android.myjail.data;
...
public class Examination {
  ...
  public Examination(Context context) {
    ...
    Question question2 = new Question(context.getString(R.string.question2));
    addQuestion(question2);
    Question question2a = new Question(context.getString(R.string.question2a));
    addQuestion(question2a);
    Question question3 = new Question(context.getString(R.string.question3));
    addQuestion(question3);
    Question question4 = new Question(context.getString(R.string.question4));
    addQuestion(question4);
    Question question4a = new Question(context.getString(R.string.question4a));
    addQuestion(question4a);
    Question question4b = new Question(context.getString(R.string.question4b));
    addQuestion(question4b);
    Question question5 = new Question(context.getString(R.string.question5));
    addQuestion(question5);
    Question question6 = new Question(context.getString(R.string.question6));
    addQuestion(question6);
    Question question7 = new Question(context.getString(R.string.question7));
    addQuestion(question7);
    Question question8 = new Question(context.getString(R.string.question8));
    addQuestion(question8);
    Question question9 = new Question(context.getString(R.string.question9));
    addQuestion(question9);
    Question question10 = new Question(context.getString(R.string.question10));
    addQuestion(question10);
    Question question11 = new Question(context.getString(R.string.question11));
    addQuestion(question11);
    Question question12 = new Question(context.getString(R.string.question12));
    addQuestion(question12);
    Question question13 = new Question(context.getString(R.string.question13));
    addQuestion(question13);
    Question question14 = new Question(context.getString(R.string.question14));
    addQuestion(question14);
    Question question15 = new Question(context.getString(R.string.question15));
    addQuestion(question15);
    Question question15a = new Question(context.getString(R.string.question15a) +
        context.getString(R.string.question15aa));
    addQuestion(question15a);
    Question question16 = new Question(context.getString(R.string.question16));
    addQuestion(question16);
    Question question17 = new Question(context.getString(R.string.question17));
    addQuestion(question17);
    Question question18 = new Question(context.getString(R.string.question18));
    addQuestion(question18);
    Question question19 = new Question(context.getString(R.string.question19));
    addQuestion(question19);
    Question question20 = new Question(context.getString(R.string.question20));
    addQuestion(question20);
    Question question21 = new Question(context.getString(R.string.question21));
    addQuestion(question21);
    Question question22 = new Question(context.getString(R.string.question22));
    addQuestion(question22);
    Question question23 = new Question(context.getString(R.string.question23));
    addQuestion(question23);
    Question question24 = new Question(context.getString(R.string.question24));
    addQuestion(question24);
    Question question25 = new Question(context.getString(R.string.question25));
    addQuestion(question25);
    Question question26 = new Question(context.getString(R.string.question26));
...
//    Log.d("TAG", "Examination: " + answer.getTextAnswer());
    ...
    cock.setNickname(new String[]{"Гребень", "Вафлер", "Чмырь", "Чмо", "Помойный","Гнида","Чулок"});
  ...
  public ArrayList<String> loadNoCorrectAnswer() {
    return null;
  }
}
